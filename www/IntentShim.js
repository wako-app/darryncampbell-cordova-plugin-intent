...
IntentShim.prototype.startActivity = function (
  params,
  successCallback,
  errorCallback
) {
...
IntentShim.prototype.startActivityForResult = function (
  params,
  successCallback,
  errorCallback
) {
  argscheck.checkArgs("off", "IntentShim.startActivityForResult", arguments);
  exec(successCallback, errorCallback, "IntentShim", "startActivityForResult", [
    params,
  ]);
};

IntentShim.prototype.sendBroadcast = function (
  params,
  successCallback,
  errorCallback
) {
...
IntentShim.prototype.startService = function (
  params,
  successCallback,
  errorCallback
) {
...
IntentShim.prototype.realPathFromUri = function (
  ...
  exec(successCallback, errorCallback, "IntentShim", "realPathFromUri", [
    params,
  ]);
};
